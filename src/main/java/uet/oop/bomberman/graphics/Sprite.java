...
public class Sprite {
  ...
  public static Sprite explosion_vertical_up_last = new Sprite(DEFAULT_SIZE, 1, 4, SpriteSheet.tiles, 16, 16);
  public static Sprite explosion_vertical_up_last1 = new Sprite(DEFAULT_SIZE, 2, 4, SpriteSheet.tiles, 16, 16);
  public static Sprite explosion_vertical_up_last2 = new Sprite(DEFAULT_SIZE, 3, 4, SpriteSheet.tiles, 16, 16);
